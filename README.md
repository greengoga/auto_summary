...
1.	Имя:
-	Должно содержать только буквы русского или латинского алфавита, пробелы.
-	Минимум 2 символа, максимум 50 символов.
-	Пример валидных данных:
-	Иван
2.	Телефон:
-	Должен начинаться с “+7”, содержать только цифры.
-	Длина: 11 цифр.
-	Пример валидных данных:
-	+79991234567
3.	Электронная почта:
-	Должна содержать символ “@”, доменную часть (например, .com, .ru).
-	Пример валидных данных:
-	ivan@example.com
---
